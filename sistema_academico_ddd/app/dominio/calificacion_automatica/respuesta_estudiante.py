...
class RespuestaEstudiante(db.Model):
    ...
    # Formato: {"1": "A", "2": "C", ...}
    respuestas_marcadas = db.Column(db.JSON, nullable=False, default=dict)
    ruta_imagen_original = db.Column(db.String(255))
    procesado_en = db.Column(db.DateTime, default=ahora_utc)
    ...
    def __repr__(self) -> str:
        return (
            f"<RespuestaEstudiante examen_id={self.examen_id} "
